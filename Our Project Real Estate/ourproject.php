...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Copy of Travel Agency" />
    ...
    <div>
      ...
      <div class="landing-page-container">
          ...
          <nav data-role="Header" class="landing-page-navbar">
            ...
            <div class="landing-page-right-side">
              <div class="landing-page-links-container">
                ...
                <span class="landing-page-text02">Privacy Policy</span>
              ...
              <div class="landing-page-nav">
                ...
                <div class="landing-page-right-side1">
                  <div class="landing-page-links-container1">
                    <span class="landing-page-text04"  style="cursor: pointer;">Home</span>
                    <span class="landing-page-text05">About</span>
                    <span class="landing-page-text06"></span>
                    <span>Contact</span>
                  </div>
          ...
          <div class="landing-page-hero">
            <div class="landing-page-content-container">
              ...
              <h2 class="subheading landing-page-subheading">
                Land for your personal and bussiness 
              </h2>
              ...
              <div class="solid-button-container">
                <button class="solid-button-button button">
                  <span><a href="https://www.makaan.com/" target="_blank">Explore homes</a></span>
                </button>
              </div>
            </div>
          </div>
        ...
        <div id="main-section" class="landing-page-main">
          <h1 style="color: black;">Most Searched places</h1>
          ...
          <div class="landing-page-cards-container">
            <div class="place-card-container">
              ...
              <div class="place-card-container1">
                <span class="place-card-text"><span style="color: black;"> For Seller</span></span>
                <span class="place-card-text1">
                  <span style="font-size: 20px; color: black; text-align: left;">
                    Sell the  argricultural lands/fields with full security,availibity and reliability of Documents
                  </span>
                </span>
                <div class="outline-button-container">
                  <button class="outline-button-button button botton">
                    <span><a href="Hackathon/Registration.php" target="_blank">Go Here</a></span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div class="place-card-container">
              ...
              />
              <div class="place-card-container1">
                <span class="place-card-text"><span style="color: black;">For Buyer</span></span>
                <span class="place-card-text1">
                  <span style="font-size: 18px; color: black; text-align: left;">
                    Buy/Rent the best suited argricultural lands/fields with full security,availibity and reliability of Document
                  </span>
                </span>
                <div class="outline-button-container">
                  <button class="outline-button-button button botton">
                    <span><a href="Hackathon/admin_registeration.php" target="_blank">Go Here</a></span>
                  </button>
                </div>
              </div>
            </div>
