...
<head>
    ...
    <link rel="stylesheet" href="entrybuyer2.css">
...
<body>
	...
	<h2 style="text-align:center;"><span style=  "  color: #ff4e00;
    border: 2px solid;
    border-radius: 20px;
    background: #f0f05e;
    padding: 7px; ">Your's Details</span></h2>
  ...
  <hr>
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col" style ="color: white;
				...
				<th class="text-center" scope="col" style ="color: white;
    			background-color: black">Student Id.</th>
				<th class="text-center" scope="col" style ="color: white;
				...
				<th class="text-center" scope="col" style ="color: white;
    			background-color: black">Edit</th>
				<th class="text-center" scope="col" style ="color: white;
    			background-color: black">Delete</th>
				<th class="text-center" scope="col"style ="color: white;
        	...
        	$get_data = "SELECT * FROM card_activation WHERE u_email='$user_email' ";
		...
		<button class="notify " ><a href="message.php" target="_blank">Check Notification</a></button>
